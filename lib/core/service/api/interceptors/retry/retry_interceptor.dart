...
class RetryInterceptor extends Interceptor {
  ...
  ///   with [defaultRetryableStatuses]
  static final FutureOr<bool> Function(DioError error, int attempt) defaultRetryEvaluator =
  ...
  RequestOptions _recreateOptions(RequestOptions options) {
    ...
    //   throw ArgumentError('requestOptions.data is not FormData', 'requestOptions');
    // }
...
extension OptionsX on Options {
  ...
  set disableRetry(bool value) => (extra ??= <String, dynamic>{})[_kDisableRetryKey] = value;
}
